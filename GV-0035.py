...
async function findGalaxy() {
  try {
    ...
    setStatus("Search complete. Galaxy table now summarizes multiple SIMBAD candidates and prefers whole-galaxy size measurements from returned catalog data instead of tiny nuclear/component values when possible.");
  } catch(err){
