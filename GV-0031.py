...
async function findGalaxy() {
  try {
    ...
    const tasks=[
      nedPromise, runCatalog("VizieR",()=>probeVizier(coords.ra,coords.dec)),
    ...
    setStatus("Search complete. Galaxy table uses SIMBAD identity plus NED/local-catalog distance fallback for nearby systems; all catalog and survey outcomes are listed below.");
