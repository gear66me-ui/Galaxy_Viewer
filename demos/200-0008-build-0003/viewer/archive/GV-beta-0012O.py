...
(async()=>{
    'use strict';
    const VERSION='12O';
    const DISPLAY_VERSION='12O';
    const ALADIN_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/vendor/aladin/aladin-classic-0001.js?v=5E9B55DBEC474DED';
    const HAMBURGER_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/hamburger-menu/gv-hamburger-menu-0003.js?v=1FAA2D715BC40A06';
    ...
    const TARGET_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/target-simbad/gv-target-simbad-0001.js?v=0D4467102BE0A84C';
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0042.js?v=7CD07B20F4295D28';
    ...
    function startAladinPreload(){
        ...
        aladinPreloadPromise=(async()=>{
            try{
                ...
                if(!window.A?.init){
                    throw new Error('ALADIN LITE 3.8.2 EXPORT MISSING');
                }
    ...
    async function ensureAladin(){
        ...
        if(!outcome?.ok){
            throw outcome?.error || new Error('ALADIN LITE 3.8.2 PRELOAD FAILED');
        }
    ...
    const moduleLoads=Promise.all([
        loadScript(HAMBURGER_URL,'gvHamburger0003'),
        loadScript(COORDINATE_URL,'gvCoordinate0004'),
        loadScript(TARGET_URL,'gvTarget0001'),
        loadScript(RANDOM_GALAXY_URL,'gvRandomGalaxy0042')
    ]);
    ...
    )throw new Error('RANDOM GALAXY 0042 HOME BOOTSTRAP EXPORT MISSING');

    window.GalaxyRandomGalaxy.bootstrapHomePresentation(root);

    // ==================== HAMBURGER MENU ====================
    if(window.GalaxyViewerHamburgerMenu?.version!=='0003')throw new Error('HAMBURGER MODULE 0003 EXPORT MISSING');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0042')throw new Error('RANDOM GALAXY 0042 EXPORT MISSING OR VERSION MISMATCH');
    if(typeof window.GalaxyRandomNavigationWindow!=='function')throw new Error('RANDOM GALAXY 0042 NAVIGATION WINDOW EXPORT MISSING');
