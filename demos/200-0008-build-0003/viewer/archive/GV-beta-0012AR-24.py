...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0100.js';
    const NAVIGATION_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/navigation/gv-navigation-0004.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScript(NAVIGATION_URL,'gvNavigation0004'),
        loadScript(NAVIGATION_ADMIN_URL,'gvNavigationAdmin0001'),
        loadScriptGithubThenLocal(BLACK_BOX_URL,'gvBlackBox0002').then(()=>loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0100')),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0100' ||
    ...
    // ==================== NAVIGATION ENGINE ====================
    if(window.GalaxyViewerNavigation?.VERSION!=='0004')
        throw new Error('NAVIGATION MODULE 0004 EXPORT MISSING OR VERSION MISMATCH');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0100')throw new Error('RANDOM GALAXY 0100 EXPORT MISSING OR VERSION MISMATCH');
    ...
    (function installTemporaryBlackBoxExporter(){
        ...
        Object.assign(host.style,{
            ...
            gap:'6px',
            padding:'8px',
            border:'1px solid rgba(88,191,255,.9)',
            borderRadius:'8px',
