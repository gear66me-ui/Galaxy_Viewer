...
(async()=>{
    'use strict';
    const VERSION='12Q';
    const DISPLAY_VERSION='12Q';
    const ALADIN_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/vendor/aladin/aladin-classic-0001.js';
    const HAMBURGER_BASE_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/hamburger-menu/gv-hamburger-menu-0005.js';
    const HAMBURGER_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/hamburger-menu/gv-hamburger-menu-0006.js';
    ...
    const TARGET_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/target-simbad/gv-target-simbad-0003.js';
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0047.js';
    ...
    const moduleLoads=Promise.all([
        loadScript(HAMBURGER_BASE_URL,'gvHamburger0005').then(()=>loadScript(HAMBURGER_URL,'gvHamburger0006')),
        loadScript(COORDINATE_URL,'gvCoordinate0005'),
        loadScript(TARGET_URL,'gvTarget0003'),
        loadScript(RANDOM_GALAXY_URL,'gvRandomGalaxy0047'),
        loadScript(DIAGNOSTICS_URL,'gvDiagnostics0004'),
        loadScript(DOWNLOAD_ANALYTICS_BASE_URL,'gvDownloadAnalytics0002').then(()=>loadScript(DOWNLOAD_ANALYTICS_URL,'gvDownloadAnalytics0003'))
    ]);
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0047' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0047 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // ==================== TARGET / SIMBAD ====================
    if(window.GalaxyViewerTargetSimbad?.version!=='0003')throw new Error('TARGET / SIMBAD MODULE 0003 EXPORT MISSING');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0047')throw new Error('RANDOM GALAXY 0047 EXPORT MISSING OR VERSION MISMATCH');
    if(typeof window.GalaxyRandomNavigationWindow!=='function')throw new Error('RANDOM GALAXY 0047 NAVIGATION WINDOW EXPORT MISSING');
