...
(async()=>{
    'use strict';
    const VERSION='12AR-132AB';
    const DISPLAY_VERSION='12AR-132AB';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0204.js';
    ...
    const RANDOM_GALAXY_VERSION='0204';
