...
(async()=>{
    ...
    )throw new Error('RANDOM GALAXY 0040 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0040')throw new Error('RANDOM GALAXY 0040 EXPORT MISSING OR VERSION MISMATCH');
    if(typeof window.GalaxyRandomNavigationWindow!=='function')throw new Error('RANDOM GALAXY 0040 NAVIGATION WINDOW EXPORT MISSING');
