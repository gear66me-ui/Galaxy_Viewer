...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0093-LAB.js';
    ...
    const STUTTER_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/diagnostics/gv-stutter-lab-0001.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScriptGithubThenLocal(STUTTER_LAB_URL,'gvStutterLab0001').then(()=>loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0093Lab')),
