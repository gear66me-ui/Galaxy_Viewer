...
(async()=>{
    'use strict';
    const VERSION='12AR-130F';
    const DISPLAY_VERSION='12AR-130F';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0161.js';
    ...
    const RANDOM_GALAXY_VERSION='0161';
