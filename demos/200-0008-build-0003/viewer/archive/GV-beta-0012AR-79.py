...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0138.js';
    ...
    const RANDOM_GALAXY_VERSION='0138';
  ...
  transform:'translate(-50%,-50%) rotate(0deg)',color:'#2F6BFF',
