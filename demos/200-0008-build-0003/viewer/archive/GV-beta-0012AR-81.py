...
body.gv-hd-open #gv-center-target{display:none!important}body:not(.gv-hd-open) #gv-galaxy-nav{display:flex!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important;z-index:7405!important}body:not(.gv-hd-open) #gv-random-galaxy{display:flex!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important}
...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0139.js';
    ...
    const RANDOM_GALAXY_VERSION='0139';
    ...
    const RETICLE_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/artwork/runtime/navigation/galaxy-viewer-reticle.svg?v=ar79';
    ...
    function createCenterReticle(root){
        ...
        // ice-blue North pointer, and Space Age N are children of this SAME rotor.
  ...
  return marker;
        ...
        northPointer.style.background="#2F6BFF";
        northPointer.style.filter='drop-shadow(0 0 3px rgba(155,229,255,.95)) drop-shadow(0 0 8px rgba(47,107,255,.62)) drop-shadow(0 0 14px rgba(155,229,255,.30))';
        // AR76-R1: top ice-blue North pointer/hotdog removed from visible reticle.
        northPointer.style.display='block';
  ...
  transform:'translate(-50%,-50%) rotate(0deg)',color:'#EAF7FF',
  ...
  whiteSpace:'nowrap',textAlign:'center'
        ...
        // AR76-R1: top ice-blue North label removed with pointer.
  ...
  lastNorthBearing:null
    ...
    function setNorthMarker(bearing){
        ...
        // Grid + ice-blue pointer + N are children of northRotor, therefore they
        ...
        // AR76-R2: keep top ice-blue North pointer/hotdog hidden.
...
`;
  ...
  pointerEvents:'none'
        ...
        // AR75-R1: top rotation/catalog banner removed from visible UI.
        host.append(button,status,download);
