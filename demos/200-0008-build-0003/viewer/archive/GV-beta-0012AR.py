...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0095-DOE.js';
    const NAVIGATION_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/navigation/gv-navigation-0003.js';
    ...
    const STUTTER_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/diagnostics/gv-stutter-lab-0004.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScript(NAVIGATION_URL,'gvNavigation0003'),
        loadScript(NAVIGATION_ADMIN_URL,'gvNavigationAdmin0001'),
        loadScriptGithubThenLocal(STUTTER_LAB_URL,'gvStutterLab0004').then(()=>loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0095Doe')),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0095' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0095 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // ==================== NAVIGATION ENGINE ====================
    if(window.GalaxyViewerNavigation?.VERSION!=='0003')
        throw new Error('NAVIGATION MODULE 0003 EXPORT MISSING OR VERSION MISMATCH');
    ...
    // Navigation 0003 is loaded globally; Random Galaxy 0092 owns the planner instance.

    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0095')throw new Error('RANDOM GALAXY 0095 EXPORT MISSING OR VERSION MISMATCH');
