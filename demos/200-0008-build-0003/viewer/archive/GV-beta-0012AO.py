...
(async()=>{
    ...
    const DIAGNOSTICS_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/diagnostics/gv-diagnostics-0006.js?v=12AO-FLIGHT-RECORDER';
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0068' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0068 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0068')throw new Error('RANDOM GALAXY 0068 EXPORT MISSING OR VERSION MISMATCH');
    ...
    // Random Galaxy 0068 is the sole preparation owner.
