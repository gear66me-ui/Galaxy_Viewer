...
(async()=>{
    'use strict';
    const VERSION='12AR-132AI';
    const DISPLAY_VERSION='12AR-132AI';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0210.js';
    ...
    const RANDOM_GALAXY_VERSION='0210';
