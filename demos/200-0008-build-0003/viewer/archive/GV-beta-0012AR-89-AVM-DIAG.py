...
(async()=>{
    ...
    const AVM_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/lab/gv-avm-overlay-lab-0003.js';
...
`;
    ...
    if(new URLSearchParams(location.search).get('avmLab')==='1'){
        loadScriptGithubThenLocal(AVM_LAB_URL,'gvAvmOverlayLab0003').then(()=>{
