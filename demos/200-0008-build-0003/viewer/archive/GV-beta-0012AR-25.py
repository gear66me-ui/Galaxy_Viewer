...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0101.js';
    const NAVIGATION_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/navigation/gv-navigation-0005.js';
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0101' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0101 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // ==================== NAVIGATION ENGINE ====================
    if(window.GalaxyViewerNavigation?.VERSION!=='0005')
        throw new Error('NAVIGATION MODULE 0005 EXPORT MISSING OR VERSION MISMATCH');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0101')throw new Error('RANDOM GALAXY 0101 EXPORT MISSING OR VERSION MISMATCH');
    ...
    (function installTemporaryBlackBoxExporter(){
        ...
        button.type='button';
        button.textContent='BLACK BOX JSON';
        ...
        download.style.font='700 9px monospace';
