...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0104.js';
    const NAVIGATION_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/navigation/gv-navigation-0006.js';
    ...
    const BLACK_BOX_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/diagnostics/gv-black-box-0002.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScript(NAVIGATION_URL,'gvNavigation0006'),
        loadScript(NAVIGATION_ADMIN_URL,'gvNavigationAdmin0001'),
        loadScriptGithubThenLocal(BLACK_BOX_URL,'gvBlackBox0002').then(()=>loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0104')),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0104' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0100 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // ==================== NAVIGATION ENGINE ====================
    if(window.GalaxyViewerNavigation?.VERSION!=='0006')
        throw new Error('NAVIGATION MODULE 0006 EXPORT MISSING OR VERSION MISMATCH');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0104')throw new Error('RANDOM GALAXY 0104 EXPORT MISSING OR VERSION MISMATCH');
