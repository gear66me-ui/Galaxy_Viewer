...
(async()=>{
    'use strict';
    const VERSION='12AR-12';
    const DISPLAY_VERSION='12AR-12';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0093.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0093'),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0093' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0093 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // Navigation 0003 is loaded globally; Random Galaxy 0093 owns the planner instance.

    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0093')throw new Error('RANDOM GALAXY 0093 EXPORT MISSING OR VERSION MISMATCH');
