...
function install(){
  ...
  installHdFeedback();
  if(core.versionLabel){core.versionLabel.textContent='VERSION 11Q';core.versionLabel.setAttribute('aria-label','GALAXY VIEWER VERSION 11Q')}
