/*
GALAXY VIEWER ENGINEERING CHANGE ORDER — RANDOM GALAXY 0052
...
(function (global) {
  ...
  const FONT_NAMES = Object.freeze({
    spaceAge: 'GV Random Galaxy Space Age 0052',
    digits: 'GV Random Galaxy Digits 0052'
  });
...
`;
    ...
    async #getProviderCandidate(excludeName) {
      if (!this.provider) throw new Error('Random Galaxy 0052 requires a local galaxy provider.');
