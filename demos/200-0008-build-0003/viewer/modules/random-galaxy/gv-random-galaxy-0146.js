                            ...
                            try{
                                ...
                                const prepared=Object.freeze({
                                    ...
                                    avmAuthorityWcs:Object.freeze({
                                        NAXIS1:Number.isFinite(Number(wcs.NAXIS1))?Number(wcs.NAXIS1):null,
                                        NAXIS2:Number.isFinite(Number(wcs.NAXIS2))?Number(wcs.NAXIS2):null,
                                        CDELT1:Number.isFinite(Number(wcs.CDELT1))?Number(wcs.CDELT1):null,
                                        CDELT2:Number.isFinite(Number(wcs.CDELT2))?Number(wcs.CDELT2):null,
                                        CROTA2:Number.isFinite(Number(wcs.CROTA2))?Number(wcs.CROTA2):null,
                                        CD1_1:Number.isFinite(Number(wcs.CD1_1))?Number(wcs.CD1_1):null,
                                        CD1_2:Number.isFinite(Number(wcs.CD1_2))?Number(wcs.CD1_2):null,
                                        CD2_1:Number.isFinite(Number(wcs.CD2_1))?Number(wcs.CD2_1):null,
                                        CD2_2:Number.isFinite(Number(wcs.CD2_2))?Number(wcs.CD2_2):null
                                    })
                                });
...
`;
    ...
    #normalizeProviderCandidate(candidate) {
      ...
      return Object.freeze({
        ...
        fovDegrees, aladinRotation, avmRotation, avmCallbackFov, avmAuthorityUrl,
