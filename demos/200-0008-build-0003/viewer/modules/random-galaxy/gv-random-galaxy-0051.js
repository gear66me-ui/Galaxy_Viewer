/*
GALAXY VIEWER ENGINEERING CHANGE ORDER — RANDOM GALAXY 0051
...
(function (global) {
  ...
  const FONT_NAMES = Object.freeze({
    spaceAge: 'GV Random Galaxy Space Age 0051',
    digits: 'GV Random Galaxy Digits 0051'
  });
...
`;
    ...
    async #getProviderCandidate(excludeName) {
      if (!this.provider) throw new Error('Random Galaxy 0051 requires a local galaxy provider.');
