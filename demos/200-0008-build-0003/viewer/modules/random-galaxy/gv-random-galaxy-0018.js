...
.gvrg-hd-science{position:absolute;left:50%;top:max(0px,env(safe-area-inset-top));z-index:4;transform:translateX(-50%);width:100vw;max-width:none;display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:1px 2px;padding:2px 3px;border:1px solid #78FFAB;border-radius:0;background:rgba(0,12,9,.72);box-shadow:inset 0 0 8px rgba(120,255,171,.08),0 0 12px rgba(77,255,143,.28);text-align:center;pointer-events:none}
.gvrg-hd-science-item{min-width:0;padding:0 1px;pointer-events:none}
.gvrg-hd-science-label{font:400 7.6px/1 "${FONT_NAMES.spaceAge}",sans-serif;letter-spacing:.14px;color:#78FFAB;text-shadow:0 0 5px rgba(87,255,147,.42);text-align:center;pointer-events:none}
.gvrg-hd-science-item:first-child .gvrg-hd-science-value{color:#78FFAB;text-shadow:0 0 6px rgba(87,255,147,.48)}
.gvrg-hd-science-value{min-height:9px;margin-top:0;font:400 9px/1.02 "${FONT_NAMES.spaceAge}",sans-serif;letter-spacing:0;color:#ffffff;text-shadow:0 0 4px rgba(205,255,224,.20);text-align:center;white-space:normal;overflow-wrap:anywhere;pointer-events:none}
