...
`;
  ...
  function installHdArchiveIntegration(randomGalaxy, options = {}) {
    ...
    if(!document.getElementById("gvrg-ar82-random-button-visible-style")){const st=document.createElement("style");st.id="gvrg-ar82-random-button-visible-style";st.textContent="body:not(.gv-hd-open) #gv-galaxy-nav,body:not(.gv-hd-open) #gv-random-galaxy{display:flex!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important}body:not(.gv-hd-open) #gv-galaxy-nav{z-index:7405!important}body.gv-hd-open #gv-galaxy-nav,body.gv-hd-open #gv-random-galaxy{display:none!important}";document.head.appendChild(st);}

    // AR82 / RANDOM 0140: force HD viewport cleanup in the real document.
    ...
    if(!document.getElementById("gvrg-ar82-hd-cleanup-style")){
        const ar82HdStyle=document.createElement("style");
        ar82HdStyle.id="gvrg-ar82-hd-cleanup-style";
        ar82HdStyle.textContent=`
...
.gvrg-hd-viewport>#gv-hd-archive-button.gv-archive-loading .gv-hd-archive-comet{
  ...
  animation:gvHdArchiveOrbit .9s linear infinite!important;
        ...
        document.head.appendChild(ar82HdStyle);
    }
...
`;
    ...
    // RANDOM 0140: safe presentation-only preview. No Aladin viewport writes.
...
async function requestRandomNavigation(){
  ...
  /*
   * RANDOM 0140 — PRE-TRAVEL DESTINATION PRESENTATION.
