  ...
  function createRandomPreparationEngine(options = {}) {
    ...
    const aladinPreparedReceipts=new Map();
        ...
        function gv0214PreparePrecomputedAvmAuthority(
            ...
            const cameraRa=Number.isFinite(Number(centerAuthority?.ra))?Number(centerAuthority.ra):ra;
            const cameraDec=Number.isFinite(Number(centerAuthority?.dec))?Number(centerAuthority.dec):dec;
        ...
        async function gv0211PrepareDirectAvmAuthority(
            ...
            const avmRa=Number(centerAuthority?.ra??wcs.CRVAL1);
            const avmDec=Number(centerAuthority?.dec??wcs.CRVAL2);
...
`;
    ...
    #normalizeProviderCandidate(candidate) {
      ...
      return Object.freeze({
        ...
        avmRa:ra, avmDec:dec, avmHorizontalFovDegrees, avmVerticalFovDegrees, avmCameraRotation:aladinRotation,
        hdUrl: hdUrl.href,
