...
(function (global) {
  ...
  const DEFAULTS = Object.freeze({
    ...
    firstHomeBirdseyeSeconds: 2,
    firstHomeBirdseyeTranslation: 0.70,
    firstHomeTranslate90Seconds: 3.5,
    firstHomeTranslate90: 0.90,
    firstHomeTranslationCompleteSeconds: 4.0,
    maxFov: 237.6,
    translateStart: 0.34,
    turnPoint: 0.46,
    translate90: 0.58,
...
`;
    ...
    async travelToRandom() {
      ...
      try {
        ...
        const firstHomeBirdseyeEnd=firstHomeTrip
          ? Math.min(
              .8,
              clamp01(
                Number(this.options.firstHomeBirdseyeSeconds)/
                Number(this.options.firstHomeTravelSeconds)
              )
            )
          : 0;
        const firstHomeTranslate90End=firstHomeTrip
          ? Math.max(
              firstHomeBirdseyeEnd,
              Math.min(
                .95,
                clamp01(
                  Number(this.options.firstHomeTranslate90Seconds)/
                  Number(this.options.firstHomeTravelSeconds)
                )
              )
            )
        ...
        const firstHomeTranslationCompleteEnd=firstHomeTrip
          ? Math.max(
              firstHomeTranslate90End,
              Math.min(
                .98,
                clamp01(
                  Number(this.options.firstHomeTranslationCompleteSeconds)/
                  Number(this.options.firstHomeTravelSeconds)
                )
              )
            )
        ...
        await new Promise((resolve, reject) => {
          const frame = (now) => {
            ...
            if(
              ...
              const firstHomeArrivalProgress=
                firstHomeTrip &&
                t>firstHomeTranslationCompleteEnd
                  ...
                  : 0;
              const firstHomeFovProgress=
                firstHomeTrip
                  ? (
                      firstHomeArrivalProgress<=.5
                        ? 2*
                          firstHomeArrivalProgress*
                          firstHomeArrivalProgress
                        : 1-
                          2*
                          (1-firstHomeArrivalProgress)*
                          (1-firstHomeArrivalProgress)
                    )
                  : t;
              const baseTravelFov=this.#fovAt(
                firstHomeFovProgress,
                startFov,
                baseDestinationFov,
                firstHomeTrip
              );
              ...
              if(firstHomeTrip){
                const firstHomeBirdseyeTranslation=
                  clamp01(
                    Number(
                      this.options.firstHomeBirdseyeTranslation
                    )
                  );
                const firstHomeTranslate90=
                  Math.max(
                    firstHomeBirdseyeTranslation,
                    clamp01(
                      Number(
                        this.options.firstHomeTranslate90
                      )
                    )
                  );
                const translationProgress=
                  t<=firstHomeBirdseyeEnd
                    ? firstHomeBirdseyeTranslation*
                      smootherstep(
                        t/firstHomeBirdseyeEnd
                      )
                    : t<=firstHomeTranslate90End
                      ? firstHomeBirdseyeTranslation+
                        (
                          firstHomeTranslate90-
                          firstHomeBirdseyeTranslation
                        )*
                        smootherstep(
                          (t-firstHomeBirdseyeEnd)/
