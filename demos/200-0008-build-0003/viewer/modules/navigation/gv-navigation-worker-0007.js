...
const WORKER_VERSION='0007';

importScripts('gv-navigation-0018.js');

const api=self.GalaxyViewerNavigation;

if(!api || api.VERSION!=='0018'){
  throw new Error('NAVIGATION WORKER 0007 — NAVIGATION 0018 LOAD FAILURE');
}
...
self.onmessage=event=>{
  ...
  if(data.type!=='PLAN'){
    self.postMessage({
      ...
      error:'NAVIGATION WORKER 0007 — UNKNOWN MESSAGE'
    });
    return;
  }
