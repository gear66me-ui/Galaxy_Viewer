...
const WORKER_VERSION='0003';

importScripts('gv-navigation-0008.js');

const api=self.GalaxyViewerNavigation;

if(!api || api.VERSION!=='0008'){
  throw new Error('NAVIGATION WORKER 0002 — NAVIGATION 0008 LOAD FAILURE');
}
...
self.onmessage=event=>{
  ...
  if(data.type!=='PLAN'){
    self.postMessage({
      ...
      error:'NAVIGATION WORKER 0002 — UNKNOWN MESSAGE'
    });
    return;
  }
