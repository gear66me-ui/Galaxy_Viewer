(()=>{
'use strict';
const VERSION="0033";const trace=(code,detail={})=>{try{globalThis.GalaxyViewerDiagnostics?.recordAvm?.(code,detail)}catch(_){}};trace("AVM_LAB_BOOT",{version:VERSION});
const WATCH_MS=260;
const ARRIVAL_SETTLE_MS=650;
const LAYER_NAME="Galaxy Viewer AVM Overlay";
const PANEL_ID="gv-avm-overlay-lab";
const STYLE_ID="gv-avm-overlay-lab-style-0033";
