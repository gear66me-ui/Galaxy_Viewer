...
replacements = [
    ...
    (
        ...
        '    setStatus("Search complete. GV-0050 used the first SIMBAD row from the 30-arcsecond cone search, kept your current view, defaults to Hubble Outreach Color, opens on the Hubble Ultra Deep Field, and displays tiny angular sizes in MAS.");'
    )
]
