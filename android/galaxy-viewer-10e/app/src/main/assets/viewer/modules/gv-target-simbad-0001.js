...
.gv-target-simbad-button[aria-pressed="true"]::before{opacity:1;background:radial-gradient(circle at 18% 20%,rgba(218,255,231,.72) 0 2px,rgba(92,255,157,.46) 5px,transparent 11px),radial-gradient(circle at 82% 22%,rgba(183,255,210,.64) 0 2px,rgba(50,244,137,.42) 6px,transparent 12px),radial-gradient(circle at 20% 82%,rgba(146,255,190,.58) 0 2px,rgba(37,226,126,.42) 7px,transparent 13px),radial-gradient(circle at 82% 80%,rgba(199,255,220,.60) 0 2px,rgba(64,249,148,.42) 7px,transparent 13px),linear-gradient(145deg,rgba(30,197,110,.97),rgba(65,246,143,.95) 48%,rgba(19,158,88,.98));box-shadow:inset 0 0 8px rgba(164,255,202,.62),inset 0 0 3px rgba(239,255,245,.70),0 0 8px rgba(85,255,136,.48)}
