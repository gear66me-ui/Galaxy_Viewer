...
public final class MainActivity extends Activity {
    private static final String APP_BASE =
            "https://gear66me-ui.github.io/Galaxy_Viewer/mobile/beta/analytics-app-0001.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logNative("APP_CREATE", "analytics-2");
        ...
        logNative("NATIVE_SPLASH_READY", "ANALYTICS MODE");
        ...
        logNative("JS_BRIDGES_READY", "downloads+native-audit");
    ...
    private void buildSplash(FrameLayout root) {
        ...
        analytics.setText("ANALYTICS MODE 2");
        ...
        fresh.setText("SECOND-BY-SECOND AUDIT · AUTO START");
    ...
    private void buildAnalyticsBadge(FrameLayout root) {
        ...
        badge.setText("ANALYTICS 2 · RECORDING");
