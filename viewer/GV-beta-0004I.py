...
#aladin-cosmic-command-test button.gv-simbad-proxy.gv-active{
    ...
    height:32px!important;min-height:32px!important;max-height:32px!important;
    flex:0 0 32px!important;align-self:center!important;
...
(() => {
    ...
    function startGalaxyViewer(){
        if(!window.A||!window.A.init){
            console.error("GV-beta-0004I STARTUP FAILURE: window.A was not created");
            return;
        }
        ...
        window.A.init.then(() => {
            ...
            function syncProxyBorder(coordinateBox,proxy){const style=window.getComputedStyle(coordinateBox);[["border-top-style",style.borderTopStyle],["border-right-style",style.borderRightStyle],["border-bottom-style",style.borderBottomStyle],["border-left-style",style.borderLeftStyle],["border-top-width",style.borderTopWidth],["border-right-width",style.borderRightWidth],["border-bottom-width",style.borderBottomWidth],["border-left-width",style.borderLeftWidth],["border-top-color",style.borderTopColor],["border-right-color",style.borderRightColor],["border-bottom-color",style.borderBottomColor],["border-left-color",style.borderLeftColor],["border-top-left-radius",style.borderTopLeftRadius],["border-top-right-radius",style.borderTopRightRadius],["border-bottom-right-radius",style.borderBottomRightRadius],["border-bottom-left-radius",style.borderBottomLeftRadius]].forEach(([property,value])=>proxy.style.setProperty(property,value,"important"));}
        ...
        }).catch(error=>console.error("GV-beta-0004I STARTUP FAILURE:",error));
    }
    ...
    if(loader){
        ...
        loader.addEventListener("error",()=>console.error("GV-beta-0004I STARTUP FAILURE: official Aladin 3.8.2 bundle failed to load"),{once:true});
        return;
    }
