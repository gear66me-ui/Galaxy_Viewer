...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0112.js';
    ...
    const RANDOM_GALAXY_VERSION='0112';
  ...
  textAlign:'right',
  whiteSpace:'nowrap',
  textShadow:'0 0 4px rgba(120,255,171,.55)',
  pointerEvents:'none'
        });
