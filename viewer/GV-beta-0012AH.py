...
(async()=>{
    ...
    const moduleLoads=Promise.all([
        ...
        loadScript(RANDOM_GALAXY_URL,'gvRandomGalaxy0063'),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0063' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0063 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // Random Galaxy 0063 is the sole preparation owner.
