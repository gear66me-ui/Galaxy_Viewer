...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0055.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScript(RANDOM_GALAXY_URL,'gvRandomGalaxy0055'),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0055' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0055 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0055')throw new Error('RANDOM GALAXY 0055 EXPORT MISSING OR VERSION MISMATCH');
