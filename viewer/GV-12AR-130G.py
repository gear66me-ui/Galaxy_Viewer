...
(async()=>{
    'use strict';
    const VERSION='12AR-130G';
    const DISPLAY_VERSION='12AR-130G';
    ...
    const RANDOM_GALAXY_URL='/modules/random-galaxy/gv-random-galaxy-0162.js';
    const NAVIGATION_URL='/modules/navigation/gv-navigation-0019.js';
