...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0108.js';
    const NAVIGATION_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/navigation/gv-navigation-0013.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScript(NAVIGATION_URL,'gvNavigation0008'),
        loadScript(NAVIGATION_ADMIN_URL,'gvNavigationAdmin0001'),
        loadScriptGithubThenLocal(BLACK_BOX_URL,'gvBlackBox0003').then(()=>loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0106')),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0107' ||
    ...
    // ==================== NAVIGATION ENGINE ====================
    if(window.GalaxyViewerNavigation?.VERSION!=='0012')
        throw new Error('NAVIGATION MODULE 0008 EXPORT MISSING OR VERSION MISMATCH');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0107')throw new Error('RANDOM GALAXY 0106 EXPORT MISSING OR VERSION MISMATCH');
