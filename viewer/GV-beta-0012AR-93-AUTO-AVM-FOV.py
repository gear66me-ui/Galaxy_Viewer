...
(async()=>{
    ...
    const AVM_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/lab/gv-avm-overlay-lab-0007.js';
...
`;
    ...
    loadScriptGithubThenLocal(AVM_LAB_URL,'gvAvmOverlayLab0007').then(()=>{
