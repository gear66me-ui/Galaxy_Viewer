...
<script src="https://raw.githubusercontent.com/gear66me-ui/Galaxy_Viewer/beta/viewer/modules/gv-uhd-viewport-0001.js?v=10AF-0001"></script>
<style>
@font-face{
...
(async()=>{
    ...
    if(hdDownloadButton){
        ...
        zoomableLabel.textContent='VIEW ZOOMABLE';
    ...
    // 10AF VIEW ZOOMABLE: the old satellite/archive icon is intentionally not mounted over the HD image.
