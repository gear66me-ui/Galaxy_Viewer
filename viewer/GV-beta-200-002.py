...
#aladin-cosmic-command-test{position:relative;width:100%;height:100vh;height:100dvh;background:#000;overflow:hidden}
...
<div id="aladin-cosmic-command-test">
  ...
  <div id="gv200-status">GV-beta-200-002 — LOADING</div>
</div>
"""))
