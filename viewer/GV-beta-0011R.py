...
function install(){
  ...
  installHdFeedback();
  if(core.versionLabel){core.versionLabel.textContent='VERSION 11R';core.versionLabel.setAttribute('aria-label','GALAXY VIEWER VERSION 11R')}
