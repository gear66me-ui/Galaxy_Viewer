...
# GV-beta-0004D
# Standalone Galaxy Viewer release based on GV-beta-0004A.
# Repairs the local Aladin loader by loading its non-module bundle as a classic
# script and using the global A object. All 4A viewer behavior is preserved.
