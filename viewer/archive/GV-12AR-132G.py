...
(async()=>{
    'use strict';
    const VERSION='12AR-132G';
    const DISPLAY_VERSION='12AR-132G';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0187.js';
    ...
    const RANDOM_GALAXY_VERSION='0187';
    ...
    function normalizeCatalogGalaxy(candidate,index,catalogKey,catalogMeta={}){
        ...
        if(!constellation)return null; // 132G: distance is optional science metadata.
