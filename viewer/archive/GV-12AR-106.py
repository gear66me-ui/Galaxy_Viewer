...
(async()=>{
    'use strict';
    const VERSION='12AR-106';
    const DISPLAY_VERSION='12AR-106';
    ...
    const AVM_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/lab/gv-avm-overlay-lab-0022.js';
...
`;
    ...
    loadScriptGithubThenLocal(AVM_LAB_URL,'gvAvmOverlayLab0022').then(()=>{
