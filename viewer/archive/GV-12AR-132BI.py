...
(async()=>{
    'use strict';
    const VERSION='12AR-132BD';
    const DISPLAY_VERSION='12AR-132BD';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0227.js';
    ...
    const RANDOM_GALAXY_VERSION='0227';
