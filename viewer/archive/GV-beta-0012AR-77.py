...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0136.js';
    ...
    const RANDOM_GALAXY_VERSION='0136';
        ...
        try{
            ...
            for(const angle of [0,90,180,270]){
                ...
                Object.assign(line.style,{
                    ...
                    height:'27px',
                    background:'#CFF4FF',
                    boxShadow:'0 0 1px rgba(207,244,255,.22)',
  ...
  return marker;
        ...
        try{
            ...
            for(const tick of northGrid.querySelectorAll('.gv-reticle-tick-major')){
                ...
                tick.style.boxShadow=cardinal?'0 0 3px rgba(207,244,255,.70),0 0 6px rgba(207,244,255,.24)':'0 0 3px rgba(70,150,255,.78)';
        ...
        northPointer.style.background="#CFF4FF";
        northPointer.style.filter='drop-shadow(0 0 3px rgba(207,244,255,.95)) drop-shadow(0 0 7px rgba(207,244,255,.48))';
        // AR76-R1: top ice-blue North pointer/hotdog removed from visible reticle.
        northPointer.style.display='none';
  ...
  transform:'translate(-50%,-50%) rotate(0deg)',color:'#CFF4FF',
  ...
  lastNorthBearing:null
    ...
    function setNorthMarker(bearing){
        ...
        state.northPointer.style.display='none';
        state.northLabel.style.display='none';
    }
