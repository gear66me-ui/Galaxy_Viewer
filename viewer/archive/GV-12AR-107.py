...
(async()=>{
    'use strict';
    const VERSION='12AR-107';
    const DISPLAY_VERSION='12AR-107';
    ...
    const AVM_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/lab/gv-avm-overlay-lab-0023.js';
...
`;
    ...
    loadScriptGithubThenLocal(AVM_LAB_URL,'gvAvmOverlayLab0023').then(()=>{
