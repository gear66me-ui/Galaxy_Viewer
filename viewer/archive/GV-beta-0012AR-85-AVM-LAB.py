...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0142.js';
    ...
    const RANDOM_GALAXY_VERSION='0142';
    const AVM_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/lab/gv-avm-overlay-lab-0001.js';
...
`;
    ...
    if(new URLSearchParams(location.search).get('avmLab')==='1'){
        loadScriptGithubThenLocal(AVM_LAB_URL,'gvAvmOverlayLab0001').then(()=>{
