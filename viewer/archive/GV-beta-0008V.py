...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/gv-random-galaxy-0018.js?v=e44ae9f940d939a6d1523f3b2a94bcab2739c84b';
    ...
    function formatTravelDistance(millionLy){
        ...
        const [integer,fraction='00']=value.toFixed(2).split('.');
        return {integer,fraction:fraction.padEnd(2,'0').slice(0,2),unit:'MILLION LIGHT-YEARS'};
    }
    ...
    await loadScript(RANDOM_GALAXY_URL,'gvRandomGalaxy0018');
    if(window.GalaxyRandomGalaxy?.VERSION!=='0011')throw new Error('RANDOM GALAXY 0018 PATH / 0011 VERIFIED CORE EXPORT MISSING');
