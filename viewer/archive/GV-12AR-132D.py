...
(async()=>{
    'use strict';
    const VERSION='12AR-132D';
    const DISPLAY_VERSION='12AR-132D';
    ...
    const RANDOM_GALAXY_URL='http://127.0.0.1:8772/viewer/modules/random-galaxy/gv-random-galaxy-0184.js';
    const NAVIGATION_URL='http://127.0.0.1:8772/viewer/modules/navigation/gv-navigation-0019.js';
    const NAVIGATION_VERSION='0019';
    const RANDOM_GALAXY_VERSION='0184';
    const AVM_LAB_URL='http://127.0.0.1:8772/viewer/modules/lab/gv-avm-overlay-lab-0040.js';
    ...
    const DIAGNOSTICS_URL='http://127.0.0.1:8772/viewer/modules/diagnostics/gv-diagnostics-0016.js';
