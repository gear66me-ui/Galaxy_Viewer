...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0092.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0092'),
