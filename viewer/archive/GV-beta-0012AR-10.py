...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0091.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0091'),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0091' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0091 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // Navigation 0003 is loaded globally; Random Galaxy 0091 owns the planner instance.

    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0091')throw new Error('RANDOM GALAXY 0091 EXPORT MISSING OR VERSION MISMATCH');
