...
(async()=>{
    ...
    const AVM_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/lab/gv-avm-overlay-lab-0004.js';
...
`;
    ...
    loadScriptGithubThenLocal(AVM_LAB_URL,'gvAvmOverlayLab0004').then(()=>{
