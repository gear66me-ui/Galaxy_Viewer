...
(async()=>{
    ...
    const moduleLoads=Promise.all([
        ...
        loadScriptGithubThenLocal(STUTTER_LAB_URL,'gvStutterLab0005').then(()=>loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0096Doe')),
