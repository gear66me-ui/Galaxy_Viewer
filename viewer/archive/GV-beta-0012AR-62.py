...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0122.js';
    ...
    const RANDOM_GALAXY_VERSION='0122';
  ...
  return null;
    ...
    if(typeof aladin.setFrame==='function')aladin.setFrame('GAL');
...
`;
    ...
    function renderCoordinates(){
        ...
        coordinate.setFrame('GAL');
        coordinate.update(latestRa,latestDec);
    }
    coordinate=window.GalaxyCoordinateOverlay.mount(coordinateHost,{onFrameChange(){
        frame='GAL';
        try{if(typeof aladin.setFrame==='function')aladin.setFrame('GAL')}catch(error){console.warn('GALAXY VIEWER FRAME CHANGE WARNING',error)}
        coordinate?.setFrame('GAL');
        renderCoordinates();
    }});
