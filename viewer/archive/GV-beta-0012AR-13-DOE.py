...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0094-DOE.js';
    ...
    const STUTTER_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/diagnostics/gv-stutter-lab-0002.js';
    ...
    const moduleLoads=Promise.all([
        ...
        loadScriptGithubThenLocal(STUTTER_LAB_URL,'gvStutterLab0002').then(()=>loadScriptGithubThenLocal(RANDOM_GALAXY_URL,'gvRandomGalaxy0094Doe')),
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0092' ||
        typeof window.GalaxyRandomGalaxy.bootstrapHomePresentation!=='function'
    )throw new Error('RANDOM GALAXY 0092 HOME BOOTSTRAP EXPORT MISSING');
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0092')throw new Error('RANDOM GALAXY 0092 EXPORT MISSING OR VERSION MISMATCH');
