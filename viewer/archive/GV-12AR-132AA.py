...
(async()=>{
    'use strict';
    const VERSION='12AR-132AA';
    const DISPLAY_VERSION='12AR-132AA';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0203.js';
    ...
    const RANDOM_GALAXY_VERSION='0203';
