...
(async()=>{
    'use strict';
    const VERSION='12AR-132BA';
    const DISPLAY_VERSION='12AR-132BA';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0224.js';
    ...
    const RANDOM_GALAXY_VERSION='0224';
