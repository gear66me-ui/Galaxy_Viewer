...
(async()=>{
    ...
    if(
        window.GalaxyRandomGalaxy?.VERSION!=='0094' ||
    ...
    // ==================== RANDOM NAVIGATION ====================
    if(window.GalaxyRandomGalaxy?.VERSION!=='0094')throw new Error('RANDOM GALAXY 0094 EXPORT MISSING OR VERSION MISMATCH');
