...
<script>(()=>{const cover=document.getElementById('gv-apk-cover');if(!cover)return;const img=cover.querySelector('img');if(img)img.src='artwork/icon.svg';const version=document.createElement('div');version.className='gv-10e-version';version.textContent='VERSION 10F';cover.appendChild(version)})();</script>
"""))
...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://raw.githubusercontent.com/gear66me-ui/Galaxy_Viewer/1e6e2de79c24164003dd313132134b3866c2ca36/viewer/modules/gv-random-galaxy-0031.js?v=eaf76aa364853e1f997c5ec439bd8e0205a5e0c8';
