...
function install(){
  ...
  installHdFeedback();
  if(core.versionLabel){core.versionLabel.textContent='VERSION 11N';core.versionLabel.setAttribute('aria-label','GALAXY VIEWER VERSION 11N')}
