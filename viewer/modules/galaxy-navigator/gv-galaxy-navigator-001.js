...
#gv-random-galaxy,.gv-galaxy-history{appearance:none;-webkit-appearance:none;position:relative;height:42px;margin:0;border:1px solid #43CFFF;border-radius:10px;background:linear-gradient(180deg,#174E86 0%,#082C59 13%,#041B3E 54%,#07366A 88%,#0D5A98 100%) padding-box;color:#F4FDFF;box-shadow:inset 0 2px 2px rgba(225,251,255,.82),inset 0 -3px 5px rgba(0,0,0,.52),inset 0 0 13px rgba(41,153,255,.34),0 0 3px #DDF8FF,0 0 9px rgba(50,190,255,.72),0 0 18px rgba(20,116,219,.35);cursor:pointer;touch-action:manipulation;outline:none;pointer-events:auto;transition:transform .08s ease,filter .12s ease,box-shadow .12s ease}
...
.gv-galaxy-history:disabled{opacity:.48;cursor:default;filter:saturate(.55)}
