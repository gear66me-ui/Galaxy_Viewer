...
#gv-random-galaxy::after,.gv-galaxy-history::after{content:"";position:absolute;left:9%;right:9%;top:3px;height:24%;border-radius:8px 8px 50% 50%;background:linear-gradient(180deg,rgba(255,255,255,.46),rgba(118,225,255,.08),transparent);pointer-events:none}
#gv-random-galaxy{position:relative;display:flex;flex:1 1 auto;min-width:0;align-items:center;justify-content:center;padding:0 12px;font:400 15.5px/1 "GV Space Age",sans-serif;letter-spacing:.38px;text-transform:uppercase;text-shadow:0 0 5px #fff,0 0 11px rgba(88,191,255,.85)}
