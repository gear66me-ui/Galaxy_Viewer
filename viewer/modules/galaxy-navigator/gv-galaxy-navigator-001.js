...
#gv-random-galaxy,.gv-galaxy-history{appearance:none;-webkit-appearance:none;position:relative;height:42px;margin:0;border:1px solid #43CFFF;border-radius:10px;background:linear-gradient(180deg,#174E86 0%,#082C59 13%,#041B3E 54%,#07366A 88%,#0D5A98 100%) padding-box;color:#F4FDFF;box-shadow:inset 0 2px 2px rgba(225,251,255,.82),inset 0 -3px 5px rgba(0,0,0,.52),inset 0 0 13px rgba(41,153,255,.34),0 0 3px #DDF8FF,0 0 9px rgba(50,190,255,.72),0 0 11px rgba(20,116,219,.30);cursor:pointer;touch-action:manipulation;outline:none;pointer-events:auto;transition:transform .08s ease,filter .12s ease,box-shadow .12s ease}
#gv-random-galaxy::after,.gv-galaxy-history::after{content:"";position:absolute;left:8%;right:8%;top:3px;height:28%;border-radius:8px 8px 50% 50%;background:linear-gradient(180deg,rgba(255,255,255,.52),rgba(118,225,255,.12),transparent);pointer-events:none}
#gv-random-galaxy{position:static;display:flex;flex:1 1 auto;min-width:0;align-items:center;justify-content:center;padding:0 12px;font:400 15.5px/1 "GV Space Age",sans-serif;letter-spacing:.38px;text-transform:uppercase;text-shadow:0 0 5px #fff,0 0 11px rgba(88,191,255,.85)}
...
.gv-galaxy-history:disabled{opacity:1;cursor:default;filter:saturate(.72) brightness(.72);background:linear-gradient(180deg,#123E6C 0%,#07284F 14%,#03162F 54%,#062B52 88%,#0A4779 100%);box-shadow:inset 0 2px 2px rgba(205,245,255,.52),inset 0 -3px 5px rgba(0,0,0,.58),inset 0 0 10px rgba(41,153,255,.22),0 0 2px rgba(221,248,255,.72),0 0 7px rgba(50,190,255,.42)}
