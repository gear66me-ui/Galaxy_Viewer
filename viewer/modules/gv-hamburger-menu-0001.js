/*
 * Galaxy Viewer Hamburger / Projection Menu Module 0001
...
(() => {
  ...
  const MODULE_VERSION = "0001";
  const STYLE_ID = "gv-hamburger-menu-0001-style";
...
.${DEFAULT_ROOT_CLASS} .gv-mol-outline,.${DEFAULT_ROOT_CLASS} .gv-mol-grid{fill:none;stroke-linecap:round;stroke-linejoin:round}.${DEFAULT_ROOT_CLASS} .gv-mol-outline{stroke:#8FEAFF;stroke-width:1.8}.${DEFAULT_ROOT_CLASS} .gv-mol-grid{stroke:#9D7CFF;stroke-width:1.15;opacity:.96}
