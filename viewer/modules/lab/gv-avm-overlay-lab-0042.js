(()=>{
'use strict';
/* AVM 0042 — pretravel reuses preparedHdUrl blob when available; authority URL remains the identity/WCS key. */
const VERSION="0042";const trace=(code,detail={})=>{try{globalThis.GalaxyViewerDiagnostics?.recordAvm?.(code,detail)}catch(_){}};trace("AVM_LAB_BOOT",{version:VERSION});
const WATCH_MS=260;
