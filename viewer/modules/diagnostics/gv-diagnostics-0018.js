...
(() => {
  'use strict';
  const VERSION='0018',POLL_MS=1000,MAX_SNAPSHOTS=900,MAX_ERRORS=250,MAX_EVENTS=2500,MAX_AVM_EVENTS=1500;
  ...
  function ledKind(kind,data={}){
    ...
    if(kind==='hd'){
      ...
      if(state==='DOWNLOADING'||state==='DECODING'||state==='PREPARING')
