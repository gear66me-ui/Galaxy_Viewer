...
.gvrg-hd-science{position:absolute;left:50%;top:max(4px,env(safe-area-inset-top));z-index:4;transform:translateX(-50%);width:min(560px,94vw);display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:3px 5px;padding:4px 6px;border:1px solid rgba(120,255,171,.84);border-radius:6px;background:rgba(0,12,9,.72);box-shadow:0 0 12px rgba(77,255,143,.22);text-align:center;pointer-events:none}
.gvrg-hd-science-item{min-width:0;padding:1px;pointer-events:none}
.gvrg-hd-science-label{font:400 10.4px/1.08 "${FONT_NAMES.spaceAge}",sans-serif;letter-spacing:.30px;color:#9eeab9;text-align:center;pointer-events:none}
