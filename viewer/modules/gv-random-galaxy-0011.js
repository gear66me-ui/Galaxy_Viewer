...
.gvrg-hd-science{position:absolute;left:50%;top:max(7px,env(safe-area-inset-top));z-index:4;transform:translateX(-50%);width:min(560px,94vw);display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:4px 6px;padding:6px 8px;border:1px solid rgba(120,255,171,.84);border-radius:6px;background:rgba(0,12,9,.72);box-shadow:0 0 12px rgba(77,255,143,.22);text-align:center;pointer-events:none}
.gvrg-hd-science-item{min-width:0;padding:1px 2px;pointer-events:none}
.gvrg-hd-science-label{font:400 9px/1.08 "${FONT_NAMES.spaceAge}",sans-serif;letter-spacing:.45px;color:#9eeab9;text-align:center;pointer-events:none}
.gvrg-hd-science-value{min-height:13px;margin-top:1px;font:400 11px/1.12 "${FONT_NAMES.spaceAge}",sans-serif;letter-spacing:.12px;color:#ffffff;text-shadow:0 0 4px rgba(205,255,224,.20);text-align:center;white-space:normal;overflow-wrap:anywhere;pointer-events:none}
