...
const WORKER_VERSION='0008';

importScripts('gv-navigation-0019.js');

const api=self.GalaxyViewerNavigation;

if(!api || api.VERSION!=='0019'){
  throw new Error('NAVIGATION WORKER 0008 — NAVIGATION 0019 LOAD FAILURE');
}
...
self.onmessage=event=>{
  ...
  if(data.type!=='PLAN'){
    self.postMessage({
      ...
      error:'NAVIGATION WORKER 0008 — UNKNOWN MESSAGE'
    });
    return;
  }
