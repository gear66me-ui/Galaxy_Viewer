...
const WORKER_VERSION='0009';

importScripts('gv-navigation-0020.js');

const api=self.GalaxyViewerNavigation;

if(!api || api.VERSION!=='0020'){
  throw new Error('NAVIGATION WORKER 0009 — NAVIGATION 0020 LOAD FAILURE');
}
...
self.onmessage=event=>{
  ...
  if(data.type!=='PLAN'){
    self.postMessage({
      ...
      error:'NAVIGATION WORKER 0009 — UNKNOWN MESSAGE'
    });
    return;
  }
