...
const WORKER_VERSION='0010';

importScripts('gv-navigation-0022.js');

const api=self.GalaxyViewerNavigation;

if(!api || api.VERSION!=='0022'){
  throw new Error('NAVIGATION WORKER 0010 — NAVIGATION 0022 LOAD FAILURE');
}
...
self.onmessage=event=>{
  ...
  if(data.type!=='PLAN'){
    self.postMessage({
      ...
      error:'NAVIGATION WORKER 0010 — UNKNOWN MESSAGE'
    });
    return;
  }
