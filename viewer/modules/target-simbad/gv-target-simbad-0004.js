/*
 * Galaxy Viewer Target / SIMBAD Module 0004
...
.gv-target-simbad-button,.gv-target-simbad-button:hover,.gv-target-simbad-button:focus,.gv-target-simbad-button:active{appearance:none;-webkit-appearance:none;position:relative;display:flex;visibility:visible;opacity:1;align-items:center;justify-content:center;width:36px;min-width:36px;max-width:36px;height:36px;min-height:36px;max-height:36px;margin:0;padding:0;overflow:hidden;background:linear-gradient(145deg,#081B3A 0%,#0B3177 42%,#1484DB 76%,#296DBD 100%);border:1px solid #7CCBFF;border-radius:6px;cursor:pointer;touch-action:manipulation;outline:none;box-shadow:inset 0 2px 2px rgba(225,251,255,.82),inset 0 -3px 5px rgba(0,0,0,.52),inset 0 0 13px rgba(41,153,255,.34),0 0 3px #DDF8FF,0 0 9px rgba(50,190,255,.72),0 0 18px rgba(20,116,219,.35);pointer-events:auto}
