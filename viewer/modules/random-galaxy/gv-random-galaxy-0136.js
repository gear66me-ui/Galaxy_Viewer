...
`;
  ...
  function installHdArchiveIntegration(randomGalaxy, options = {}) {
    ...
    // AR77 / RANDOM 0136: force HD viewport cleanup in the real document.
    ...
    if(!document.getElementById("gvrg-ar77-hd-cleanup-style")){
        const ar77HdStyle=document.createElement(style);
        ar77HdStyle.id="gvrg-ar77-hd-cleanup-style";
        ar77HdStyle.textContent=`
...
.gvrg-hd-viewport>#gv-hd-archive-button.gv-archive-loading .gv-hd-archive-comet{
  ...
  animation:gvHdArchiveOrbit .9s linear infinite!important;
        ...
        document.head.appendChild(ar77HdStyle);
    }
...
`;
    ...
    // RANDOM 0136: safe presentation-only preview. No Aladin viewport writes.
...
async function requestRandomNavigation(){
  ...
  /*
   * RANDOM 0136 — PRE-TRAVEL DESTINATION PRESENTATION.
