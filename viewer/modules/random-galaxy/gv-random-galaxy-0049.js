...
#gv-we-are-here .gv-earth-icon{position:relative;isolation:isolate;display:inline-flex;align-items:center;justify-content:center;font:22px/1 system-ui,sans-serif;filter:grayscale(1) sepia(1) saturate(8) hue-rotate(82deg) brightness(1.22) drop-shadow(0 0 2px rgba(87,255,147,.34))}
