...
.gvrg-card{position:absolute;left:50%;top:auto;bottom:54px;transform:translateX(-50%);width:calc(100vw - 24px);max-width:none;padding:4px 5px 4px;border:1px solid #78FFAB;border-radius:6px;background:rgba(0,12,8,.78);box-shadow:inset 0 0 10px rgba(120,255,171,.10),0 0 14px rgba(77,255,143,.34);opacity:0;transition:opacity .20s ease;pointer-events:none}
...
.gvrg-actions{display:grid;grid-template-columns:minmax(0,1fr) 36px;gap:5px;align-items:stretch;margin-top:3px;pointer-events:none}
