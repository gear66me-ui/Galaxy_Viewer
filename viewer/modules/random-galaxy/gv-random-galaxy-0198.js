/*
RANDOM GALAXY 0198 — READY-BEFORE-CLAIM FIX
- RANDOM GALAXY is clickable only when FUTURE[0] HD/AVM presentation is ready.
- First accepted tap still gives immediate PREPARING TRIP + comet feedback.
- Defensive preflight prevents claiming a trip that would then wait on network readiness.
- Obsolete Aladin-prewarm readiness remains removed from the Random gate.
- FIFO ownership, Monte Carlo ordering, AVM registration, HD preparation,
  and travel choreography are unchanged.
