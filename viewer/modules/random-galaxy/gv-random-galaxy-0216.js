...
`;
    ...
    #formatTravelHudDistance(millionLy) {
      ...
      if(total<1){scale=1_000_000;unit='LIGHT-YEARS'}
...
async function requestRandomNavigation(){
  ...
  if(!avmReadyForFlight){
    try{
      ...
      GV_TRACE.enabled&&gvTraceError(
        11903,
        'AR119_VISIBLE_AVM_PRETRAVEL_FAILED',
        error
      );
      randomNavigationWindow.rollbackPending?.();
      throw error;
