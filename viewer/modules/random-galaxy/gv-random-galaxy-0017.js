...
.gvrg-hd-science{position:absolute;left:50%;top:max(4px,env(safe-area-inset-top));z-index:4;transform:translateX(-50%);width:min(560px,94vw);display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:3px 5px;padding:4px 6px;border:1px solid #78FFAB;border-radius:6px;background:rgba(0,12,9,.72);box-shadow:inset 0 0 8px rgba(120,255,171,.08),0 0 12px rgba(77,255,143,.28);text-align:center;pointer-events:none}
.gvrg-hd-science-item{min-width:0;padding:1px;pointer-events:none}
.gvrg-hd-science-label{font:400 10.4px/1.08 "${FONT_NAMES.spaceAge}",sans-serif;letter-spacing:.30px;color:#78FFAB;text-shadow:0 0 5px rgba(87,255,147,.42);text-align:center;pointer-events:none}
.gvrg-hd-science-item:first-child .gvrg-hd-science-value{color:#78FFAB;text-shadow:0 0 6px rgba(87,255,147,.48)}
.gvrg-hd-science-value{min-height:13px;margin-top:1px;font:400 11.7px/1.10 "${FONT_NAMES.spaceAge}",sans-serif;letter-spacing:.08px;color:#ffffff;text-shadow:0 0 4px rgba(205,255,224,.20);text-align:center;white-space:normal;overflow-wrap:anywhere;pointer-events:none}
