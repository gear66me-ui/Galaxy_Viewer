/* Galaxy Viewer Random Galaxy extension 0042. Extends frozen 0040. */
(() => {
  'use strict';
  const VERSION='0042', DISPLAY_VERSION='12H';
  const base=window.GalaxyRandomGalaxy;
  if(!base||base.VERSION!=='0040')throw new Error('RANDOM GALAXY 0042 REQUIRES FROZEN 0040');
  ...
  if(typeof originalGetState==='function'&&!base.prototype.__gv0042StateWrapped){
    Object.defineProperty(base.prototype,'__gv0042StateWrapped',{value:true});
  ...
  window.GalaxyRandomGalaxy0042=Object.freeze({VERSION,DISPLAY_VERSION,bannerIdentity,finalize});
})();
