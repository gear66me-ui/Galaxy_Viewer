...
`;
    ...
    #fovAt(t, startFov, destinationFov, immediate = false) {
      ...
      // DOE 0094 — physically separated three-phase choreography.
      //
      // PHASE 1:
      //   0 -> translateStart
      //   zoom from starting FOV to maximum FOV.
      //
      // PHASE 2:
      //   translateStart -> translationComplete
      //   hold maximum FOV while translation + rotation execute.
      //
      // PHASE 3:
      //   translationComplete -> 1
      //   hold final center/orientation while zooming to destination FOV.

      const zoomOutEnd =
        clamp01(Number(this.options.translateStart));

      const zoomInStart =
        clamp01(Number(this.options.translationComplete));
