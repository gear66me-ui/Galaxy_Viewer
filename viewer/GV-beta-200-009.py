...
window.GV_BOOT_CONFIG=Object.freeze({
    ...
    travelPresentationUrl:'https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-travel-presentation-0243.js'
});
...
if(window.GalaxyRandomTravelPresentation?.VERSION!=='0243'||typeof window.GalaxyRandomTravelPresentation.mount!=='function')throw new Error('RANDOM TRAVEL PRESENTATION 0243 EXPORT MISSING');
