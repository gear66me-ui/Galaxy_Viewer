...
if(window.GalaxyDestinationPresentation?.VERSION!=='0002'||typeof window.GalaxyDestinationPresentation.mount!=='function')throw new Error('DESTINATION PRESENTATION 0002 EXPORT MISSING');
