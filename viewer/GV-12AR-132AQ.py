...
(async()=>{
    'use strict';
    const VERSION='12AR-132AQ';
    const DISPLAY_VERSION='12AR-132AQ';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0217.js';
    ...
    const RANDOM_GALAXY_VERSION='0217';
