...
(async()=>{
    ...
    function createCenterReticle(root){
        ...
        const NORTH_POINTER_RADIUS=RING_RADIUS+28;
        const NORTH_LABEL_RADIUS=RING_RADIUS+13;
  ...
  return marker;
        ...
        northPointer.style.transform='translate(-50%,-50%) rotate(180deg)';
        northPointer.style.background=COSMIC_BLUE;
        northPointer.style.filter='drop-shadow(0 0 3px rgba(88,191,255,.92)) drop-shadow(0 0 7px rgba(88,191,255,.42))';
  ...
  lastNorthBearing:null
    ...
    function readCelestialNorthBearing(aladin,root){
        try{
            // AR57: Aladin live viewport rotation is authoritative.
            // A positive image rotation moves celestial North by the
            // opposite screen angle. Normalize to 0..360.
