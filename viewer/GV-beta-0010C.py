...
#gv-apk-cover{flex-direction:column;gap:18px}#gv-apk-cover .gv-10c-version{color:#FFD85A;font:400 16px/1 "Space Age",sans-serif;letter-spacing:1.2px;text-shadow:0 0 7px rgba(255,216,90,.55);white-space:nowrap}
</style>
<div id="aladin-cosmic-command-test"></div>
<script>(()=>{const cover=document.getElementById('gv-apk-cover');if(!cover)return;const img=cover.querySelector('img');if(img)img.src='artwork/icon.svg';const version=document.createElement('div');version.className='gv-10c-version';version.textContent='VERSION 10C';cover.appendChild(version)})();</script>
"""))
...
(async()=>{
    ...
    const HUBBLE_CATALOG_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/image-databases/Hubble/databases/gv-hubble-galaxies-full-0006.json?v=74bae1c45befeefe73c3cc68771f531574c0c8e2';
