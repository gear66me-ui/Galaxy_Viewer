...
(async()=>{
    'use strict';
    const VERSION='12AR-119';
    const DISPLAY_VERSION='12AR-119';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0147.js';
    ...
    const RANDOM_GALAXY_VERSION='0147';
