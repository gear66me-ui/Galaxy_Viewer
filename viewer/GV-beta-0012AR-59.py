...
(async()=>{
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0117.js';
    ...
    const RANDOM_GALAXY_VERSION='0117';
  ...
  return marker;
        ...
        // Triangle is born pointing upward. At bearing zero its tip therefore
        // points inward and touches the outside circumference.
