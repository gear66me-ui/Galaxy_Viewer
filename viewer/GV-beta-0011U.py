...
function install(){
  ...
  installHdFeedback();
  if(core.versionLabel){core.versionLabel.textContent='VERSION 11U';core.versionLabel.setAttribute('aria-label','GALAXY VIEWER VERSION 11U')}
