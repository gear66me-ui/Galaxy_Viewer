...
(async()=>{
    'use strict';
    const VERSION='12AR-130I';
    const DISPLAY_VERSION='12AR-130I';
    ...
    const RANDOM_GALAXY_URL='/modules/random-galaxy/gv-random-galaxy-0166.js';
    ...
    const AVM_LAB_URL='/modules/lab/gv-avm-overlay-lab-0039.js';
