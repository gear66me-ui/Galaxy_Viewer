...
# GV-beta-0003D
# Standalone Galaxy Viewer release based on the known-good GV-beta-0003C state.
# Replaces the synchronized moving rainbow across the active Target icon and
# the "or Tap Target Again / to Exit" text with a synchronized discrete
# three-blue sequence that changes every 500 milliseconds.
