...
#aladin-cosmic-command-test button.gv-target-proxy[aria-pressed="true"] .gv-target-comet i:nth-child(1){
    opacity:1!important;transform:scale(.82)!important;background:#B8FFD8!important;
    box-shadow:0 0 2px 1px #FFFFFF,0 0 6px 2px rgba(106,255,178,.95),0 0 10px 3px rgba(41,219,132,.55)!important;
}
