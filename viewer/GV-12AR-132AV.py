...
(async()=>{
    'use strict';
    const VERSION='12AR-132AV';
    const DISPLAY_VERSION='12AR-132AV';
    ...
    const AVM_LAB_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/lab/gv-avm-overlay-lab-0051.js';
