...
(async()=>{
    'use strict';
    const VERSION='12AR-132AR';
    const DISPLAY_VERSION='12AR-132AR';
    ...
    const RANDOM_GALAXY_URL='https://gear66me-ui.github.io/Galaxy_Viewer/viewer/modules/random-galaxy/gv-random-galaxy-0218.js';
    ...
    const RANDOM_GALAXY_VERSION='0218';
