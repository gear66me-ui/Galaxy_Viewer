...
(async()=>{
  ...
  return marker;
        ...
        try{
            ...
            for(const tick of northGrid.querySelectorAll('.gv-reticle-tick-major')){
                ...
                tick.style.boxShadow='0 0 2px rgba(88,191,255,.42)';
  ...
  return null;
    ...
    // ==================== 12AR-70 EARTH COMPASS PRESENTATION ====================
