...
(async()=>{
    'use strict';
    const VERSION='12N';
    const DISPLAY_VERSION='12N';
    const ALADIN_URL='https://gear66me-ui.github.io/Galaxy_Viewer/aladin-source-clone/dist/aladin.js';
